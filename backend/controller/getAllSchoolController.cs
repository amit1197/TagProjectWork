...
namespace AdoNet.Controllers
{
    ...
    public class getAllSchoolController : ControllerBase
    {
...

        {
            ...
            SqlConnection con = new SqlConnection(_configuration.GetConnectionString("DefaultConnectionInstitute"));
        ...
        public async Task<IActionResult> UpdateSchoolVerify(Institute school)
        {
            ...
            connString = new SqlConnection(_configuration.GetConnectionString("DefaultConnectionInstitute"));
